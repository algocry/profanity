...
function encd(dataToEnc){
    var salt = ["\x38\x30\x38\x30\x38\x30\x38\x30\x38\x30\x38\x30\x38\x30\x38\x30", "\x70\x61\x72\x73\x65", "\x55\x74\x66\x38", "\x65\x6E\x63", "\x43\x42\x43", "\x6D\x6F\x64\x65", "\x50\x6B\x63\x73\x37", "\x70\x61\x64", "\x65\x6E\x63\x72\x79\x70\x74", "\x41\x45\x53"];
    var key = CryptoJS[salt[3]][salt[2]][salt[1]](salt[0]);
    var iv = CryptoJS[salt[3]][salt[2]][salt[1]](salt[0]);
    var encryptedData = CryptoJS[salt[9]][salt[8]](CryptoJS[salt[3]][salt[2]][salt[1]](dataToEnc), key, { keySize: 128 / 8, iv: iv, mode: CryptoJS[salt[5]][salt[4]], padding: CryptoJS[salt[7]][salt[6]] });
